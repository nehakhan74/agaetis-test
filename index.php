...
<form action="display.php" method="post" id="nameform">
    <label for="title">Title* <select  name="Title" id="Title" size="1">
        ...
        <label for="DOB">Date of Birth </label><br><input type="date" id="Date" name="date" required><br>
        <label for="Telephone">Telephone</label><br><input type="tel" id="phone" name="phone" required placeholder="" ><br>
